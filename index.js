...
async function generateLinks(argoDomain, entryIP) {
  ...
  const vless = `vless://${UUID}@${ip}:${CFPORT}?encryption=none&security=tls&sni=${argoDomain}&fp=firefox&type=ws&host=${argoDomain}&path=%2Fvless-argo%3Fed%3D2560#${encodeURIComponent(nodeName)}`;
  ...
  const trojan = `trojan://${UUID}@${ip}:${CFPORT}?security=tls&sni=${argoDomain}&fp=firefox&type=ws&host=${argoDomain}&path=%2Ftrojan-argo%3Fed%3D2560#${encodeURIComponent(nodeName)}`;
  ...
  if (bestIPResults.length > 1) {
    for (let i = 1; i < bestIPResults.length; i++) {
      ...
      allLinks += `vless://${UUID}@${r.ip}:${CFPORT}?encryption=none&security=tls&sni=${argoDomain}&fp=firefox&type=ws&host=${argoDomain}&path=%2Fvless-argo%3Fed%3D2560#${encodeURIComponent(suffix)}\n`;
    }
  }
